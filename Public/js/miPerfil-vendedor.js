...
let v_NombreTramoMiPerfil = document.getElementById('NombreTramoMiPerfil');
...
function editarPerfil() {    
    ...
    document.getElementById('NombreTramoMiPerfil').style.display = 'block';  
    document.getElementById('NombreTramoMiPerfilOutput').style.display = 'none';  
...
function guardarPerfil (){
    ...
    if ((v_claveMiPerfil.value=="") || v_emailMiPerfil.value==""||v_telefonoMiPerfil.value=="" || v_NombreTramoMiPerfil.value==""  )  {
    swal.fire({                
        icon: "warning",
        iconColor: "#f7953e",
        ...
        document.getElementById('telefonoMiPerfilOutput').innerHTML = v_NombreTramoMiPerfil.value;      

        document.getElementById('NombreTramoMiPerfil').style.display = 'none';    
        document.getElementById('NombreTramoMiPerfilOutput').style.display = 'block';  
        document.getElementById('NombreTramoMiPerfilOutput').innerHTML = v_NombreTramoMiPerfil.value;       
